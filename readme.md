...
Part 1 uses the [NoSQL_setup_starter.ipynb](https://github.com/RachaelCaldwell/nosql-challenge/edit/main/starter_code/resources/NoSQL_setup_starter.ipynb) to complete the following tasks:
